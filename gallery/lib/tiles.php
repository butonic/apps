...
/*		$this->image = new \OC_Image();
	...
	public function get($extra = '') {
		...
		return '<a rel="images" title="'.\OCP\Util::sanitizeHTML(basename($this->getPath())).'" href="'.\OCP\Util::linkTo('files','download.php', array('file' =>$this->getPath())).'"><img rel="images" src="'.\OCP\Util::linkTo('gallery', 'ajax/thumbnail.php', array('filepath'=>$this->getPath())).'" '.$extra.'></a>';
	}
